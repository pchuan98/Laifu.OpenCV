...
CVAPI_MATEXPR_FUNC_WRAP(create, *ret = new cv::MatExpr(), cv::MatExpr **ret)
...
CVAPI_MATEXPR_FUNC_WRAP_SPE(getDiag, *ret = new cv::MatExpr(obj->diag(d)), const int d, cv::MatExpr **ret)
