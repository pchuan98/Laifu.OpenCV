...
// refer https://github.com/shimat/opencvsharp/blob/ca1f60877aff090de5e3e456c06c7827f33f364d/src/OpenCvSharp/Cv2/Cv2_imgcodecs.cs
...
public static partial class Cv2
{
    ...
    /// <returns></returns>
    public static Mat ImRead(string fileName, ImreadModes flags = ImreadModes.IMREAD_COLOR)
    {
        ...
        ImageCodecsMethod.Imread(fileName, (int)flags, out var handle).ThrowHandleException();
    ...
    public static Mat ImDecode(ReadOnlySpan<byte> span, ImreadModes flags)
    {
        ...
        unsafe
        {
            ...
            {
                ImageCodecsMethod.Imdecode(pBuf, span.Length, (int)flags, out var ret).ThrowHandleException();
                return new Mat(ret);
            }
        }
    }
